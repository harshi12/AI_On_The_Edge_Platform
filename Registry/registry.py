...
class Registry:
    ...
    def Restore_DS(self):
        ...
        with open(json_path+'Storage_info.json') as json_file:
    ...
    def Store_DS(self):
        ...
        with open(json_path+'Storage_info.json', 'w') as json_file:
            json.dump(self.Storage_info, json_file)
        with open(json_path+'Service_inst_info.json', 'w') as json_file:
            json.dump(self.Service_inst_info, json_file)
        with open(json_path+'Service_inst_info.json', 'w') as json_file:
            json.dump(self.Service_inst_info, json_file)
        with open(json_path+'App_inst_info.json', 'w') as json_file:
            json.dump(self.App_inst_info, json_file)
        with open(json_path+'Host_Creds.json', 'w') as json_file:
            json.dump(self.Host_Creds, json_file)
        with open(json_path+'Platform_Module_Info.json', 'w') as json_file:
            json.dump(self.Platform_Module_Info, json_file)
        with open(json_path+'Gateway_Creds.json', 'w') as json_file:
