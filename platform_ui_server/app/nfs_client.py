...
class NFS(object):
    ...
    def mount(self, sourcePath, destinationPath):
        ...
        os.system('echo %s|sudo %s' % (self.password, command))
    ...
    def copy(self, source, destination):
        ...
        os.system('echo %s | sudo chmod -R 777 %s' %(self.password, destination))

    def mkdir(self, destinationPath):
        os.system('mkdir ' + destinationPath)
        print("%s Created\n" %(destinationPath))
        os.system('echo %s | sudo chmod -R 777 %s' %(self.password, destinationPath))
    ...
    def delete(self, path):
        os.system('echo yes | sudo rm -R ' + path)
